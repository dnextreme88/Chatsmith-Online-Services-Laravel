	...
	<div class="row">
		...
		@foreach ($announcements as $announcement)
			<div class="col-md-12 alert alert-info alert-block">
				...
				<p class="text-left">Posted by <strong>{{ $announcement->user->username }}</strong> on <strong>{{ \Carbon\Carbon::parse($announcement->created_at)->format('F j, Y g:i:s') }}</strong></p>
