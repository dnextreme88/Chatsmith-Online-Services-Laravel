...
@section('content')
<div class="container">
	<x-custom.breadcrumbs :nav_links="['Tasks' => route('tasks.index')]">Create Task</x-custom.breadcrumbs>

	<div class="card">
		<x-custom.card-header-title>{{ __('Add Task Form') }}</x-card-header-title>
