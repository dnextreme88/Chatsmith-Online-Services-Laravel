    ...
    <div class="carousel slide testimonials" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 1" />
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 2" />
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 3" />
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 4" />
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 5" />
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/carousel_five_stars.webp') }}" class="d-none d-md-block w-25 mx-auto my-4 carousel-rating" alt="Testimonial 6" />
                <div class="carousel-caption">
